...
namespace ExtensionsSample
{
    ...
    {
        public static void SqlQueue_Trigger_Basic([SqlQueueTrigger(DatabaseName = "SqlQueue", QueueName = "RECEIVERQUEUE1", ContractName = "C", MessageDataType = "VarChar(Max)")] string queueMessage)
        {
        ...
        public static void SqlQueue_Trigger_With_Metadata([SqlQueueTrigger(QueueName = "RECEIVERQUEUE2", ContractName = "C")] string queueMessage, SqlQueueTriggerValue messageValue)
        {
